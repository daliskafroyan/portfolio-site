 ...
 */
const require_rdt_hook = require('./rdt-hook-B0BphmA3.cjs');
const require_core = require('./core-BgmbcjsU.cjs');
...
exports.areFiberEqual = require_core.areFiberEqual;
...
exports.traverseFiberAsync = require_core.traverseFiberAsync;
exports.traverseFiberSync = require_core.traverseFiberSync;
